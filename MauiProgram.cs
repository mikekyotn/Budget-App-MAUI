        ...
        public static MauiApp CreateMauiApp()
        {
            ...
            using (var scope = app.Services.CreateScope())
            {
                ...
                if(!context.Payments.Any())
                {
                    ...
                    new Payment { Type = PaymentType.Income, DayOfMonthDue = 1, Month = PaymentMonth.TEMPLATE, Description = "My Job", Category = "Salary", Comments = "NA", IsPaid = false, AmountEstimated=0.00m, AmountActual=0, Year = 0 }
                    );
                    context.SaveChanges();
                }
